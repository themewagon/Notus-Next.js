          ...
          <div className='flex flex-wrap items-center'>
            ...
            <div className='w-full md:w-5/12 px-4 mr-auto ml-auto mt-32'>
              <div className='relative flex flex-col min-w-0 w-full mb-6 mt-48 md:mt-0'>
                <img
                  alt='...'
                  src={useAsset("/img/component-btn.png")}
                  className='w-full align-middle rounded absolute shadow-lg max-w-100-px left-145-px -top-29-px z-3'
                />
                <img
                  alt='...'
                  src={useAsset("/img/component-profile-card.png")}
                  className='w-full align-middle rounded-lg absolute shadow-lg max-w-210-px left-260-px -top-160-px'
                />
                <img
                  alt='...'
                  src={useAsset("/img/component-info-card.png")}
                  className='w-full align-middle rounded-lg absolute shadow-lg max-w-180-px left-40-px -top-225-px z-2'
                />
                <img
                  alt='...'
                  src={useAsset("/img/component-info-2.png")}
                  className='w-full align-middle rounded-lg absolute shadow-2xl max-w-200-px -left-50-px top-25-px'
                />
                <img
                  alt='...'
                  src={useAsset("/img/component-menu.png")}
                  className='w-full align-middle rounded absolute shadow-lg max-w-580-px -left-20-px top-210-px'
                />
                <img
                  alt='...'
                  src={useAsset("/img/component-btn-pink.png")}
        ...
        <div className='container mx-auto px-4 pb-32 pt-48'>
          <div className='items-center flex flex-wrap'>
            ...
            <div className='w-full md:w-6/12 mr-auto px-4 pt-24 md:pt-0'>
              <img
                alt='...'
                src={useAsset("/img/documentation.png")}
